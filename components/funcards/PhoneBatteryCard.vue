<template>
  <Card class="fun-card bg-gradient-to-r dark:from-gray-800/20">
    <div class="absolute h-full bg-gradient-to-l from-gray-200/80 dark:from-gray-700/60" :style="{ width: `${ data.batteryLevel }%` }" />
